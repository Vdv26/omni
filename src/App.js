...
function App() {
  ...
  // Context value — FIX: use `gigs` state (not undefined `mockData`)
  const contextValue = {
    gigs,
    favorites,
    toggleFavorite,
    ...
    user,
    handleLogout,
    allGigs: gigs   // ✅ was: allGigs: mockData (mockData is out of scope here)
  };
    ...
    <Router>
      <AppContext.Provider value={contextValue}>
        <div className="App" data-testid="app-container">
          ...
          {/* CategoryMenu now returns null — category filtering handled by Hero modal */}
          <CategoryMenu 
...
// Home Page Component — FIX: pass onSearch and onSelectCategory down to Hero
function HomePage({ searchQuery, activeCategory, filteredGigs, onSearch, onSelectCategory }) {
  return (
    <>
      {!searchQuery && !activeCategory && (
        <Hero
          onSearch={onSearch}                 // ✅ was: <Hero /> with no props
